...
class Profile extends React.Component {
	constructor(props) {
		super(props);
//    this.state = {id: '', name: '', image: '', headline: '', country: '', bioSummary: '', username: '', date_created: '', skills: [], education: [], interest: [], experiences: []};
  this.state = {id: '', name: '', headline: '', username: ''};
...
fetch('http://bio.torre.co/api/bios/kingjuwon4christ',
{
  mode: 'cors',
  method: 'GET',
  cache: 'no-cache',
              ...
              <div className="row d-flex align-items-end">
                <div className="col-md-8">
                  <div className="restaurant-detailed-header-left">
                    ...
                    <p className="text-white mb-1">{this.state.headline}
